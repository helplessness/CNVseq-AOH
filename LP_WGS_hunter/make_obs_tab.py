...
def retrive_bases(bam_filename,legend_filename,sample_filename,output_filename,fasta_filename='',handle_multiple_observations='all',min_bq=30,min_mq=30,max_depth=0,compress='unc',**kwargs):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-od', '--output-dir', metavar='OUTPUT_DIR', type=str,
